...
workflow = strongdm.Workflow(
    name = "Delete WorkflowRole Python Example",
...
role = strongdm.Role(
    name="Role for Deleting WorkflowRole Python Example",
)
...
print("\tID:", workflow_role_id)

# Delete a WorkflowRole
client.workflow_roles.delete(workflow_role_id, timeout=30)
print("Successfully deleted WorkflowRole.")